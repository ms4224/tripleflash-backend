...
router.post('/decks', function(req, res){
        ...
        cardFncs.newDeck(req.body.deck, () => {
...
router.post('/cards', function(req, res){
        ...
        console.log('req----------------------------------------------',req.body);
        cardFncs.insertFlashCard(req.body.kanji, req.body.hiragana, req.body.english, req.body.deck, req.body.sampleSentence, req.body.tag, () => {
            console.log('done updating.')
            res.status(200);
            res.send({message: 'done updating'});
        })
...
router.get('/cards/:deck', function(req, res) {
    ...
    cardFncs.getCards(req.params.deck, () => {
